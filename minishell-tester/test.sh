...
# # Add test case
exec_test "echo 'alsdf\"ll\"\"ads'"
exec_test "echo  \"\"  test \"\"     test     \"\"    test\"\" | cat -e"
exec_test "echo  \"\"  test \"\"     test     \"\"test\"\" | cat -e"
exec_test "echo  \"\"  test \"\"     test     test\"\" | cat -e"
exec_test "echo  \"\"test \"\"     test     \"\"test\"\" | cat -e"
exec_test "echo  \"\"test \"\"     test     \"\"test \"\" | cat -e"
...
exec_test "echo  \"\" \"\"test\"\"test\"\"test\"\" | cat -e"
exec_test "echo  \"\" \"\"test\"\"test\"\" \"\"\"\"\"\"test\"\" | cat -e"
exec_test "echo sdfas'asd\"asd'asdf | cat -e"
exec_test "echo test  |> a cat -e"
# exec_test "echo test  >| a cat -e"
exec_test "echo test  >>; a cat -e"
...
exec_test "ls |> a"
exec_test "ls >| a"
exec_test "echo \"\$HOME\"\$HOME"
exec_test "echo \"sfd\"as''df\"\""
exec_test "echo \"a\"\"b\" | cat -e"
exec_test "echo \"\" \"\"\"\""
exec_test "echo \"aaa\$HOME\$HOME--\""
exec_test "echo 'aaa\$HOME\$HOME--'"
...
#SPECIAL
exec_test "echo 1 | \$skjafjksdfhjkasd | echo 2"
exec_test "export a=\"<aa     aa\"; echo \$a"
exec_test "export b=\"  \"; export c=\"c\";echo 1 > \$b\$c"
exec_test "export b=\"  \"; export c=\"c\";echo 1 > \$c\$b\$c"
exec_test "echo 1 > \$b"
exec_test "echo a=\"< asdf \""
exec_test "echo 'asdfas\'asdf'asdf'"
exec_test "echo \"asdf\dg\""
exec_test "echo 'asdf\$HOME-dg'"
exec_test "echo 'asdf\\\$HOME-dg'"
exec_test "echo \"asdf\\\$HOME-dg\""
exec_test "echo \"sdf\$HOMEsdf\""
exec_test "echo \"sdf\\sdf\""
exec_test "echo \"asdf\\\`asdf\""
exec_test "echo \\\"\\ \\;\\ \""
exec_test "echo $"
exec_test "echo $\"HOME\""
exec_test "echo \"das \$ HOME\""
exec_test "echo \"das \$HOME\""
